...
public class AdminController {
    ...
    @Autowired
    public AdminController(DashBoardService dashBoardService, UserService userService,VaccineService vaccineService) {
    ...
    public List<User> getUsersByRole(@RequestParam UserRole userRole) {
