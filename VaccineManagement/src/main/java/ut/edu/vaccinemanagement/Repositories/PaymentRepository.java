...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    List<Payment> findByUserIdAndPaymentDateBetweenOrderByPaymentDateDesc(
            Long userId, Date startDate, Date endDate);

    List<Payment> findByUserIdAndTransferDescriptionContainingIgnoreCaseOrderByPaymentDateDesc(
